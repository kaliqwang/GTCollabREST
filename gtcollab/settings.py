"""
Django settings for gtcollab project on Heroku. For more info, see:
...
SECRET_KEY = 'qg64*p0y77g(2vbwc5%6a)i^qkg#$t5(0xd&!g=!t%)q^8m59-'
...
WSGI_APPLICATION = 'gtcollab.wsgi.application'
